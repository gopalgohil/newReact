  ...
  return (
    <div>
      <nav className='flex justify-between items-center py-4 px-6 md:px-24 bg-white-sm  w-full ' > 
        ...
        <ul className={`md:flex md:space-x-6  left-0  flex gap-2 bg-white absolute md:static top-16 md:items-center space-y-4 md:space-y-0 md:w-auto md:bg-transparent w-full md:flex-row flex-col   transistion-all-300  ${isOpen ? "flex" : "hidden"}`}>
            <li className='hover:text-purple-600 cursor-pointer text-lg'>Home</li>
